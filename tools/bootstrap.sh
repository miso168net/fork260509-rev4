...
BETTERLEAKS_VER="1.7.1"
BETTERLEAKS_GET="處置：下載 https://github.com/betterleaks/betterleaks/releases/download/v${BETTERLEAKS_VER}/betterleaks_${BETTERLEAKS_VER}_linux_x64.tar.gz 與同頁 checksums.txt（檔名不含版號）→ sha256sum -c checksums.txt --ignore-missing 驗證 → 解壓 betterleaks 至 ~/.local/bin"
