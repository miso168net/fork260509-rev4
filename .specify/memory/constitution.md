...
- **(g)** 非-manage 頂層自助頁：`views/user-center/index.vue`＋可選 `modules/*`——登入者本人 profile 自助檢視／編輯＋改密碼＋驗證 UI 佔位，消費 auth-only 自助端點（operator＝本人）＋對應 i18n key；`hideInMenu:true`、經頭像下拉入口、非 Casbin menu——**嚴格限「登入者本人自助」、不擴張到管理他人資料／任意新 UI**
...
**Version**: 1.12.0 | **Ratified**: 2026-07-03 | **Last Amended**: 2026-07-17
