...
| 0069 | accepted | 2026-07-19 | 016 觀測層總綱——rev3 018 全套移植為底＋rev4 增項（obs 排程逐筆重審之映射表） | — | — | — |
| 0070 | accepted | 2026-07-19 | 後端 log 全環境 JSON 化＋trace_id 進 log＋completion log（B-054／B-045 子項配套） | — | — | — |
...
| 0080 | draft | 2026-07-29 | 私鑰 B′（passphrase 加殼 identity）× SECRETS_DIR 解法 2（$HOME/.cache/rev4-secrets）——三實測閘定案與 #11 反轉後重拍 | — | — | — |
