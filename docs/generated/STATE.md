...
- pins：base-web=24acbfa｜rust-api=6e7268f

## constitution
- 版本：1.4.1

## 帳面統計
- ADR：41（accepted 38、superseded 3）
- BACKLOG 待辦：52（next：B-079）
- LESSONS：124 筆（next：L-125）
- events：8 筆（feature_close 7、misc 1）
