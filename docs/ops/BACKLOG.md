...
- B-087｜sys_menu::list_tree_governed_source_and_top_level_pagination 偶發假紅（單 txn 內兩次 list_tree、READ COMMITTED 下與並行 committed-row 併發測競態→total 15 vs 14；修法候選＝兩次斷言改容忍並行位移、或同語句快照比對）｜該假紅再現時（出處：011 U2 spec 審查附註、005/010 同家族 flake 先例 L-138 近緣）
